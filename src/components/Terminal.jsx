...
const RESPONSES = {
  help: () => HELP_TEXT,
  whoami: () =>
    `Name   : Davis Asish\nRole   : Junior AI/ML Engineer · CSE\nFocus  : Multimodal DL · GPU-accelerated data science · End-to-end AI products\nStack  : PyTorch · RAPIDS · Next.js/TypeScript · D3.js · Docker · Claude API\nStatus : Open to full-time & internship opportunities`,
  bio: () =>
  ...
  skills: () =>
    `[ML/AI]        PyTorch · EfficientNet-B0 · Transformers · Multimodal Fusion (GMU)\n               AI Ethics & Safety · Bias Mitigation · Publication-Grade Evaluation\n[Accel. DS]    NVIDIA RAPIDS · cuDF · cuML · CUDA Memory Mgmt · GPU Pipelines\n[Signal Proc]  ECG/PCG Analysis · CWT · Log-Mel · WFDB · MIT-BIH · CinC 2016\n[Front-End]    React · Next.js 14 · TypeScript · D3.js · Chart.js · WebGL\n[Generative]   Stable Diffusion Turbo · Diffusers · img2img · Style Transfer\n[AI APIs]      Anthropic Claude API · Streaming · Prompt Engineering\n[Infra]        Docker · Linux/WSL2 · GitHub Actions · Vercel · Razorpay\n[Security]     Entropy Analysis · HaveIBeenPwned k-Anon · Cryptographic Tooling`,
  'execute skills.py': () => RESPONSES.skills(),
  projects: () =>
    `1. MMA-Net                    — Multimodal arrhythmia detection (F1=0.855 · AUC=0.889)\n   └─ EfficientNet-B0 + GMU · ECG+PCG fusion · 5-class AAMI · Minor Project Report\n2. NeuralStyleTransferApp     — Local Stable Diffusion Turbo · Flask · Docker\n   └─ Text-to-image + 6-preset style transfer · GPU/CPU auto-detect\n3. Uppucheppa                 — Premium e-commerce + Claude Sonnet AI chatbot\n   └─ Next.js 14 · TypeScript · Sanity v3 · Razorpay · Shiprocket\n4. Password Strength Analyzer — Entropy scoring · HaveIBeenPwned k-anon · Streamlit\n   └─ Keyboard-walk detection · leet-speak normalization · Docker\n5. TicTacToe AI               — Unbeatable Minimax opponent · PyGame`,
  contact: () =>
